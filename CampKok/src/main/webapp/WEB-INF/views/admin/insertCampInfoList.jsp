...
<head>
<meta charset="UTF-8">
<title>Insert Camp Info List</title>
</head>
<body>
	<div class="wrap">
		...
		<div class="content-wrap">
			...
			<div class="content-main">
				<h1>
					<a href="/selectTempCampInfoList.do?reqPage=1">신규등록 캠핑장정보 관리</a>
				</h1>
				<hr>
						...
						<tbody>
							...
							<c:forEach items="${list }" var="campInfo">
								<tr>
									...
									<td>
										<a href="/selectTempCampInfo.do?campNo=${campInfo.campNo }"><strong>${campInfo.campName }</strong></a>
									</td>
									<td>${campInfo.campAddr }</td>
									<td>${campInfo.campTel }</td>
									<td>
										<button class="btn btn-warning btn-md" onclick="location.href='/selectTempCampInfo.do?campNo=${campInfo.campNo }'">상세보기</button>
									</td>
								</tr>
							</c:forEach>
						</tbody>
