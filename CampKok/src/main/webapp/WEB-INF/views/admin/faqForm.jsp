					...
					<form action="/insertFAQInfo.do" method="POST" enctype="multipart/form-data">
						<table class="table table-striped">
							...
							<tr>
								<th>내용</th>
								<td colspan="3">
									<textarea rows="20" class="form-control" name="faqContents" id="faqContents"></textarea>
								</td>
							</tr>
							<tr>
								<td colspan="4">
									<input class="btn btn-warning btn-lg" type="submit" onclick="submitContents(this)" value="등록하기">
								</td>
							</tr>
						</table>
					</form>
