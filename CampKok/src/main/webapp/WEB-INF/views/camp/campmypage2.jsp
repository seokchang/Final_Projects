            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <table>
                            <tr>
                                <td><input type="text" style="width: 245px; height: 30px;" name="envName" class="envname" value="${ce.envName }"></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <table>
                            <tr>
                                <td><input type="text" style="width: 245px; height: 30px;" name="envAddr" class="envaddr" value="${ce.envAddr }"></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <table>
                            <tr>
                                <td><input type="text" style="width: 245px; height: 30px;" name="envTel" class="envtel" value="${ce.envTel }"></td>
                            </tr>
                        </table>
                    </td>
                </tr>
